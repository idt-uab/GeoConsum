...
import com.idt.ontomedia.geoconsum.fragments.RegulationDetailFragment;
...
public class RegulationDetailActivity extends BaseActivity 
{
    ...
    public void onCreate(Bundle _savedInstanceState) 
    {
        ...
        getSupportFragmentManager().beginTransaction()
        				   			.add(R.id.fragment_frame_frameLayout, new RegulationDetailFragment(this), FRAGMENT_TAG)
        				   			.commit();
    }
}