...
public abstract class DatabaseCursorLoader extends AsyncTaskLoader<Cursor> 
{
	...
	{	
		...
		// IMPORTANT: tough seems to be the correct thing to close here the previous cursor
		// before getting a new one, it makes the application crash. Duh'
